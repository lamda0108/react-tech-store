  ...
  async function handleSubmit(e) {
    ...
    if (token) {
      ...
      if (order) {
        ...
        showAlert({
          msg: "There was an error for your order. Please try again",
          type: "danger",
        });
      }
    } else {
...
const StripeWrapper = () => {
  return (
    <StripeProvider apiKey="pk_test_51H935NHgVfVlvNKykqMm2WgRVHiUUCeNrNlF5z7tWDJS2dEvrl4TcMizKLGSvehewErsJICnlKb07XLSEo7uXeZp00piDysgHw">
      <Elements>
        <CardForm></CardForm>
      </Elements>
    </StripeProvider>
